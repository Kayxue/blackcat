...
export default {
  ...
  run: async function (interaction) {
    ...
    let guilds = await interaction.client.shard.fetchClientValues("guilds.cache.size");
    let players = await interaction.client.shard.fetchClientValues("players.size");
